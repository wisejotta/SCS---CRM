...
const theme = {
  ...
  themes: {
    light: {
      dark: false,
      colors: {
        'primary': localStorage.getItem(`lightThemePrimaryColor`) || '#5c5be5',
        // 'primary': localStorage.getItem('lightThemePrimaryColor') || '#4A148C', // NOTE:: New CRM
        'on-primary': '#fff',
        'secondary': '#A8AAAE',
        'on-secondary': '#fff',
        'success': '#28C76F',
    ...
    dark: {
      dark: true,
      colors: {
        'primary': localStorage.getItem(`${themeConfig.app.title}-darkThemePrimaryColor`) || '#4A148C',
        'on-primary': '#fff',
        'secondary': '#A8AAAE',
        'on-secondary': '#fff',
        'success': '#28C76F',
