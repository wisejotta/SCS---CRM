...
export const useCalendar = (event, isEventHandlerSidebarActive, isLeadDialogVisible, isLeftSidebarOpen, userId = undefined) => {
  // 👉 themeConfig
  ...
  const calendarOptions = {
    ...
    eventClassNames({ event: calendarEvent }) {
      const colorName = calendarEvent._def.extendedProps.bo ? 'success' : 'primary'
    ...
    eventClick({ event: clickedEvent }) {
      ...
      isLeadDialogVisible.value = true
    },
